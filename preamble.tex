...
% font sizes and styles% Exakte Schriftgrößen gemäß Richtlinie
\addtokomafont{chapter}{\sffamily\fontsize{14}{14}\selectfont\bfseries}  % 14pt, fett
\addtokomafont{section}{\sffamily\fontsize{12}{12}\selectfont\bfseries}  % 12pt, fett
\addtokomafont{subsection}{\sffamily\fontsize{12}{12}\selectfont\bfseries} % 12pt, fett
\addtokomafont{subsubsection}{\sffamily\fontsize{12}{12}\selectfont} % 12pt, normal

% url font style
\usepackage{relsize}
\renewcommand*{\UrlFont}{\ttfamily\smaller\relax}

% Kapitel beginnen immer auf rechter Seite
...
\usepackage{float}         % enables the H float option
...
\newcommand{\appendixchapter}[1]{
    ...
    \setcounter{page}{1}  % Reset page counter for each appendix
    \chapter{#1}
}
